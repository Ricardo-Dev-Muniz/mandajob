...
class AdapterSearchForYou(
    private var context: Context,
    private var mutableList: List<DiscoverMore?>,
) : RecyclerView.Adapter<AdapterSearchForYou.ViewHolder>() {
    ...
    class ViewHolder(
        ...
        fun bind(data: DiscoverMore) {
            ...
            itemBinding.cvProjectHome.setOnClickListener {
                ...
                Log.e("tag_key_query", "Key in FY: ${data.key}")
            }
